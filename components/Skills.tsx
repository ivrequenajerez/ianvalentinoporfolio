...
const Skills: React.FC = () => {
  return (
    <section id="sobremi">
      <div className="lg:h-[40rem] w-full flex flex-wrap gap-20 pb-32 lg:pb-0 lg:gap-0 lg:flex-nowrap lg:items-center justify-center dark:bg-black bg-slate-100">
        <PinContainer
          title="Html, CSS, JavaScript, TypeScript"
          href="https://github.com/ivrequenajerez"
        >
          <div className="flex basis-full flex-col p-4 tracking-tight text-black dark:text-slate-100/50 sm:basis-1/2 w-[20rem] h-[20rem]">
