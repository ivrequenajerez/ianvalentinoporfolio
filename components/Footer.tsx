...
const Footer = () => {
  return (
    <footer className="bg-gray-dark rounded-lg shadow dark:bg-gray-900 m-4 my-20">
      <div className="w-full max-w-screen-xl mx-auto p-4 md:py-8">
        <div className="sm:flex sm:items-center sm:justify-between">
          ...
          <ul className="flex flex-wrap items-center mb-6 text-sm font-medium text-gray-500 sm:mb-0 dark:text-gray-light">
            <li>
              <a href="https://linkedin.com/in/ianvalentino" className="hover:underline me-4 md:me-6   ">
                LinkedIn
              </a>
            </li>
            <li>
              <a href="https://www.instagram.com/_ianvalentino/" className="hover:underline me-4 md:me-6">
                Instagram
              </a>
            </li>
            <li>
